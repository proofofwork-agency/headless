...
:::note Private beta
Headless is an unpublished private beta (`0.2.0-beta.8`). Packages are not on npm; build from source, use disposable projects, and do not entrust it with sensitive source, valuable credentials, or unattended spend yet.
:::
