...
Fleet health should report the backend as ready (the observer TUI shows this as `Ready` in its Fleet tab). If it reports `login_required` despite a working login, see [Fleet says "login required"](../troubleshooting/login-required.md).
