...
> **Unpublished private beta (`0.2.0-beta.8`).** This plugin is not published; its version and peer dependency on `@proofofwork-agency/headless` stay aligned with core at `0.2.0-beta.8`. Use disposable projects until release gates pass.
