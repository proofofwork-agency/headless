...
Default help contains only the Beta 1 execution, project-lifecycle, and foreground-lead onboarding boundary. Every other command requires the explicit `headless experimental` namespace and has no stability promise.
