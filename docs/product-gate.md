...
Case studies and Gate B/C evidence dogfood orchestration and write **kernels**, not full product bootstrap. Private beta remains unpublished (`0.2.0-beta.8`); a green Product Gate does not publish the package.
